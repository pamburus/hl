...
Tasks reference US1–US6 labels which correspond to spec.md user stories as follows:

| Tasks label | spec.md User Story |
|-------------|--------------------|
| US1 | User Story 5 — Configure Preferred Pager via Configuration File (P1) |
| US2 | User Story 6 — Priority-Based Pager Fallback (P1) |
| US3 | User Story 7 — Role-Specific Pager Arguments (P2) |
| US4 | User Story 4 — Custom Pager Selection via Environment Variables (P2) |
| US5 | User Story 8 — Follow Mode Pager Override (P2) |
| US6 | User Story 9 — Backward Compatibility with PAGER (P3) |
