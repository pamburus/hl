...
- **Base** — Works with both dark and light backgrounds.

## Available Themes

### Universal (Multi-Mode)

**`universal`** (base, 16-color)
...
**`classic-plus`** (base, 16-color)
- Enhanced classic theme with underlined keys and improved contrast.
- Works on both dark and light backgrounds.

**`neutral`** (base, 16-color)
