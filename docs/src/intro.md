...
This guide covers everything from basic installation to advanced filtering techniques. If you're new to `hl`, start with the [Installation](./installation.md) and [Quick Start](./quick-start.md) sections. For specific features, browse the [Features](./features/viewing-logs.md) section in the table of contents.
