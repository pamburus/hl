...
// local imports
use super::ast::{self, Composite, Source, SourceRef};

// ---

pub type String<'r> = log_ast::model::String<SourceRef<'r>>;
pub type Value<'r> = log_ast::model::Value<'r, SourceRef<'r>>;
pub type Array<'r> = log_ast::model::Array<'r, SourceRef<'r>>;
pub type ArrayIter<'r> = log_ast::model::ArrayIter<'r, SourceRef<'r>>;
pub type Object<'r> = log_ast::model::Object<'r, SourceRef<'r>>;
pub type ObjectIter<'r> = log_ast::model::ObjectIter<'r, SourceRef<'r>>;
pub type Field<'r> = (String<'r>, Value<'r>);
