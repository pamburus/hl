...
impl fmt::Display for Error {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            Self::ExpectedArrayComma => f.write_str("expected comma or array end"),
            Self::ExpectedArrayEnd => f.write_str("expected array end"),
            Self::ExpectedMap => f.write_str("expected map"),
            Self::ExpectedMapComma => f.write_str("expected comma or map end"),
            Self::ExpectedMapColon => f.write_str("expected colon"),
