...
impl RawValue {
    pub fn from_string(s: String) -> Result<Box<Self>, Error> {
        let borrowed = super::from_str::<&Self>(&s)?;
...
impl<'de> Deserializer<'de> for &'de RawValue {
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_any(visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_bool(visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_i8(visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_i16(visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_i32(visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_i64(visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_i128(visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_u8(visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_u16(visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_u32(visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_u64(visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_u128(visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_f32(visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_f64(visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_char(visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_str(visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_string(visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_bytes(visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_byte_buf(visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_option(visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_unit(visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_unit_struct(name, visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_newtype_struct(name, visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_seq(visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_tuple(len, visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_tuple_struct(name, len, visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_map(visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_struct(name, fields, visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_enum(name, variants, visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_identifier(visitor)
    }
    ...
    where
        V: Visitor<'de>,
    {
        super::Deserializer::from_str(&self.v).deserialize_ignored_any(visitor)
    }
}
