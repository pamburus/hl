...
//
// These tests cover all cases and edge cases to prevent regressions in the JsonDelimitSearcher
// logic. The JsonDelimitSearcher is responsible for finding newline delimiters between top-level
