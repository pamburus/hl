...
pub mod root {
    ...
    mod _private {
        ...
        pub(crate) const TYPE_ID: u64 = 0xc085_ceee_3e96_85d1;
    }
}
...
pub mod source_file {
    ...
    impl <'a,> Builder<'a,>  {
        ...
        #[inline]
        pub fn set_blocks(&mut self, value: ::capnp::struct_list::Reader<'_,crate::index_capnp::source_block::Owned>) -> ::capnp::Result<()> {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 106] = [
            ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
            ::capnp::word(147, 247, 249, 13, 61, 150, 13, 228),
            ...
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(162, 0, 0, 0, 118, 1, 0, 0),
        ...
        pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
        pub(crate) static MEMBERS_BY_NAME : &[u16] = &[5,4,3,2,1,0];
        pub(crate) const TYPE_ID: u64 = 0xe40d_963d_0df9_f793;
    }
    ...
    pub mod modified {
        ...
        mod _private {
            ...
            pub(crate) const TYPE_ID: u64 = 0xc4cd_0f09_eb67_a613;
        }
    }
}
...
pub mod source_block {
    ...
    mod _private {
        ...
        pub(crate) const TYPE_ID: u64 = 0xcce1_5778_4fde_0260;
    }
}
...
pub mod index {
    ...
    mod _private {
        ...
        pub(crate) const TYPE_ID: u64 = 0xff78_b66c_3434_661c;
    }
    ...
    pub mod entries {
        ...
        mod _private {
            ...
            pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
            pub(crate) static MEMBERS_BY_NAME : &[u16] = &[1,0];
            pub(crate) const TYPE_ID: u64 = 0xbfd5_817a_2d8f_09a7;
        }
    }
    ...
    pub mod timestamps {
        ...
        mod _private {
            ...
            pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
            pub(crate) static MEMBERS_BY_NAME : &[u16] = &[1,0];
            pub(crate) const TYPE_ID: u64 = 0xadd1_d9ea_f476_b4cd;
        }
        ...
        pub mod min {
            ...
            mod _private {
                ...
                pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
                pub(crate) static MEMBERS_BY_NAME : &[u16] = &[1,0];
                pub(crate) const TYPE_ID: u64 = 0x9685_db8e_9079_4fc3;
            }
        }
        ...
        pub mod max {
            ...
            mod _private {
                ...
                pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
                pub(crate) static MEMBERS_BY_NAME : &[u16] = &[1,0];
                pub(crate) const TYPE_ID: u64 = 0xb9a9_eb77_b665_ea78;
            }
        }
    }
}
...
pub mod chronology {
    ...
    impl <'a,> Builder<'a,>  {
        ...
        #[inline]
        pub fn set_bitmap(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::primitive_list::Owned<u64>>) -> ::capnp::Result<()> {
            ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false)
        }
        #[inline]
        ...
        #[inline]
        pub fn set_jumps(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::primitive_list::Owned<u32>>) -> ::capnp::Result<()> {
            ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(3), value, false)
        }
        #[inline]
    ...
    mod _private {
        ...
        pub(crate) const TYPE_ID: u64 = 0xe945_f478_2ba1_9815;
    }
    ...
    pub mod offsets {
        ...
        impl <'a,> Builder<'a,>  {
            ...
            #[inline]
            pub fn set_bytes(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::primitive_list::Owned<u32>>) -> ::capnp::Result<()> {
                ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(1), value, false)
            }
            #[inline]
        ...
        mod _private {
            ...
            pub(crate) const TYPE_ID: u64 = 0x8d3b_737f_3c62_907e;
        }
    }
}
...
impl ::capnp::introspect::Introspect for HashAlgorithm {
    fn introspect() -> ::capnp::introspect::Type { ::capnp::introspect::TypeVariant::Enum(::capnp::introspect::RawEnumSchema::new(&hash_algorithm::ARENA, hash_algorithm::get_annotation_types)).into() }
}
impl ::core::convert::From<HashAlgorithm> for ::capnp::dynamic_value::Reader<'_> {
    fn from(e: HashAlgorithm) -> Self { ::capnp::dynamic_value::Enum::new(e.into(), ::capnp::introspect::RawEnumSchema::new(&hash_algorithm::ARENA, hash_algorithm::get_annotation_types).into()).into() }
}
...
pub mod hash {
    ...
    mod _private {
        ...
        pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
        pub(crate) static MEMBERS_BY_NAME : &[u16] = &[0,1];
        pub(crate) const TYPE_ID: u64 = 0xe371_a299_6e52_f182;
    }
}
pub const FLAG_LEVEL_ERROR: u64 = 8;
pub const FLAG_LEVEL_WARNING: u64 = 32;
pub const FLAG_LEVEL_INFO: u64 = 256;
pub const FLAG_LEVEL_DEBUG: u64 = 4096;
pub const FLAG_LEVEL_TRACE: u64 = 16384;
pub const FLAG_LEVEL_MASK: u64 = 65535;
pub const FLAG_UNSORTED: u64 = 65536;
pub const FLAG_HAS_TIMESTAMPS: u64 = 131072;
