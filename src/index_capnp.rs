...
pub mod root {
    ...
    impl ::capnp::traits::HasStructSize for Builder<'_> {
        const STRUCT_SIZE: ::capnp::private::layout::StructSize =
            ::capnp::private::layout::StructSize { data: 0, pointers: 1 };
    }
...
pub mod source_file {
    ...
    impl<'a> Reader<'a> {
        ...
        pub fn get_blocks(
            self,
        ) -> ::capnp::Result<::capnp::struct_list::Reader<'a, crate::index_capnp::source_block::Owned>> {
            ::capnp::traits::FromPointerReader::get_from_pointer(
    ...
    impl ::capnp::traits::HasStructSize for Builder<'_> {
        const STRUCT_SIZE: ::capnp::private::layout::StructSize =
            ::capnp::private::layout::StructSize { data: 3, pointers: 4 };
    }
    impl ::capnp::traits::HasTypeId for Builder<'_> {
        const TYPE_ID: u64 = _private::TYPE_ID;
    }
    ...
    impl<'a> Builder<'a> {
        ...
        pub fn get_blocks(
            self,
        ) -> ::capnp::Result<::capnp::struct_list::Builder<'a, crate::index_capnp::source_block::Owned>> {
            ::capnp::traits::FromPointerBuilder::get_from_pointer(
        ...
        pub fn set_blocks(
            &mut self,
            value: ::capnp::struct_list::Reader<'_, crate::index_capnp::source_block::Owned>,
        ) -> ::capnp::Result<()> {
            ::capnp::traits::SetterInput::set_pointer_builder(
        ...
        pub fn init_blocks(
            self,
            size: u32,
        ) -> ::capnp::struct_list::Builder<'a, crate::index_capnp::source_block::Owned> {
...
pub mod source_block {
    ...
    impl ::capnp::traits::HasStructSize for Builder<'_> {
        const STRUCT_SIZE: ::capnp::private::layout::StructSize =
            ::capnp::private::layout::StructSize { data: 2, pointers: 3 };
    }
    impl ::capnp::traits::HasTypeId for Builder<'_> {
        const TYPE_ID: u64 = _private::TYPE_ID;
    }
...
pub mod index {
    ...
    impl ::capnp::traits::HasStructSize for Builder<'_> {
        const STRUCT_SIZE: ::capnp::private::layout::StructSize =
            ::capnp::private::layout::StructSize { data: 6, pointers: 0 };
    }
    impl ::capnp::traits::HasTypeId for Builder<'_> {
        const TYPE_ID: u64 = _private::TYPE_ID;
    }
...
pub mod chronology {
    ...
    impl ::capnp::traits::HasStructSize for Builder<'_> {
        const STRUCT_SIZE: ::capnp::private::layout::StructSize =
            ::capnp::private::layout::StructSize { data: 0, pointers: 4 };
    }
    impl ::capnp::traits::HasTypeId for Builder<'_> {
        const TYPE_ID: u64 = _private::TYPE_ID;
    }
    ...
    impl<'a> Builder<'a> {
        ...
        pub fn set_jumps(
            &mut self,
            value: impl ::capnp::traits::SetterInput<::capnp::primitive_list::Owned<u32>>,
        ) -> ::capnp::Result<()> {
            ::capnp::traits::SetterInput::set_pointer_builder(
                self.builder.reborrow().get_pointer_field(3),
                value,
...
impl ::capnp::introspect::Introspect for HashAlgorithm {
    fn introspect() -> ::capnp::introspect::Type {
        ::capnp::introspect::TypeVariant::Enum(::capnp::introspect::RawEnumSchema {
            encoded_node: &hash_algorithm::ENCODED_NODE,
            annotation_types: hash_algorithm::get_annotation_types,
        })
        .into()
    }
}
impl ::core::convert::From<HashAlgorithm> for ::capnp::dynamic_value::Reader<'_> {
    fn from(e: HashAlgorithm) -> Self {
