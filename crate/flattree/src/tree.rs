    ...
    S: Storage<Value = V>,
{
    ...
    #[inline]
    pub fn metaroot(&mut self) -> NodeBuilder<S> {
        NodeBuilder {
            tree: self,
            index: None,
            children: 0,
    ...
    #[inline]
    pub fn with_composite_node(mut self, value: S::Value, f: impl FnOnce(NodeBuilder<S>) -> NodeBuilder<S>) -> Self {
    ...
    #[inline]
    pub fn build(&mut self, value: S::Value, f: impl FnOnce(NodeBuilder<S>) -> NodeBuilder<S>) -> &mut Self {
    ...
    S: Storage<Value = V>,
{
    ...
    #[inline]
    fn build(mut self, value: S::Value, f: impl FnOnce(Self::Child) -> Self::Child) -> Self {
...
pub struct NodeBuilder<'t, S>
where
    S: Storage,
{
    tree: &'t mut FlatTree<S::Value, S>,
    index: Option<usize>,
    children: usize,
}
...
impl<'t, S> Build for NodeBuilder<'t, S>
where
    S: Storage,
{
    type Value = S::Value;
...
impl<'t, S> From<(NodeBuilderSnapshot, &'t mut FlatTree<S::Value, S>)> for NodeBuilder<'t, S>
where
    S: Storage,
{
    #[inline]
