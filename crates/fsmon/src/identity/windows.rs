...
/// Open a file with full share flags so it succeeds even when the file is
/// currently being renamed or deleted (e.g., during log rotation) or held
/// open without flush by an active writer.
