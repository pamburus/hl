...
* Install using [nix profile](https://nix.dev/manual/nix/2.18/command-ref/new-cli/nix3-profile-install)

  ```sh
  nix profile install github:pamburus/hl
  ```

* Install using [nix-flakes](https://wiki.nixos.org/wiki/Flakes)
