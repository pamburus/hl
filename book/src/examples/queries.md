...
# Less than
hl -q 'response_size < 1024' app.log

# Less than or equal
hl -q 'retry_count <= 3' app.log
```
...
hl -q 'not exists(user_id)' app.log
```
...
```hl/dev/null/shell.sh#L1
hl -q 'transaction_type = "payment" and amount > 10000 and status != "completed"' payments.log
```
