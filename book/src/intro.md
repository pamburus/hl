...
- **Developers** debugging applications that output JSON logs
...
1. **Speed**: Processes logs at approximately 2 GiB/s during initial indexing
...
4. **Reliability**: Handles hundreds of gigabytes across hundreds of files
